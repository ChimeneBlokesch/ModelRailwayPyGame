...
RAILS_IMG_FILE = {RAILS_STRAIGHT: "rails_straight.png",
                  RAILS_CURVE: "rails_curve.png",
                  RAILS_SWITCH: "rails_switch.png"}
...
# relative degrees: (absolute degrees, start x, start y, flip, next/prev ref_punt)
RAILS_DEFAULTS_CURVE_45 = {0: (180, -2, 0, HEIGHT_RAILS, True, NEXT),
                           45: (90, 0, 2, HEIGHT_RAILS, False, PREV),
                           90: (270, 0, -2, HEIGHT_RAILS, True, NEXT),
                           135: (180, -2, 0, HEIGHT_RAILS, False, PREV),
                           180: (0, 2, 0, HEIGHT_RAILS, True, NEXT),
                           225: (270, 0, -2, HEIGHT_RAILS, False, PREV),
                           270: (90, 0, 2, HEIGHT_RAILS, True, NEXT),
                           315: (0, 2, 0, HEIGHT_RAILS, False, PREV)}
...
def RAILS_OBJ_NAME(type_rails, angle=None):
    ...
    mapping = {RAILS_STRAIGHT: "straight", RAILS_CURVE: "curve"}
...
def REF_PUNT_STRAIGHT(is_horizontal, go_left_down):
...
class Rails:
    def __init__(self, name, pos_x=0, pos_y=0, pos_z=HEIGHT_RAILS, rotation=0,
...
class Curve(Rails):
    def __init__(self, name, angle, is_flipped=False,
                 pos_x=0, pos_y=0, pos_z=HEIGHT_RAILS,
        ...
        self.image_file = self.image_file(RAILS_CURVE)
        self.relative_rotation = rotation
        self.object = self.create_object()

        self.type = RAILS_CURVE

    def create_object(self):
        info = RAILS_DEFAULTS_CURVE_45[self.relative_rotation]
        ...
        return Object3D(RAILS_MAP,
                        RAILS_OBJ_NAME(RAILS_CURVE, self.angle), swap_yz=True)
...
class Straight(Rails):
    def __init__(self, name, is_horizontal=True, go_left_down=False,
                 pos_x=0, pos_y=0, pos_z=HEIGHT_RAILS,
                 rotation=0, next_rails=None, prev_rails=None):
        ref_punt_prev, ref_punt_next = REF_PUNT_STRAIGHT(
        ...
        self.image_file = self.image_file(RAILS_STRAIGHT)
        self.object = self.create_object()
        self.type = RAILS_STRAIGHT
        self.go_left_down = go_left_down

    def create_object(self):
        return Object3D(RAILS_MAP, RAILS_OBJ_NAME(RAILS_STRAIGHT), swap_yz=True)
